...
public class WaveFormView extends View {
    ...
    public void setWaveForm(GraphItem graphItem) {
...
//            double value = ymin + (ymax - ymin) / nPoints * i;
//            value = Math.round(value * 100) / 100.0;
//            canvas.drawText(Double.toString(value), (float) left - 90, (float) (height - bottom) / nPoints * (nPoints - i), textPaint );
//        }
//        for (int i = 0; i <= nPoints; i ++){
//            int value = (int) (xmin + (xmax - xmin) / nPoints * i);
//            canvas.drawText(Integer.toString(value), (float) (width - right - left) / nPoints * i + left, (float) (height - bottom + 50), textPaint );
//        }
        int step1 = 5;
        int max1 = (int) ymax;
        int min1 = (int) ymin;
